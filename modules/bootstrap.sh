...
source "$PROJECT_ROOT/modules/desktop_submit.sh"
source "$PROJECT_ROOT/modules/desktop_export.sh"
source "$PROJECT_ROOT/modules/profiles.sh"
source "$PROJECT_ROOT/modules/inspect.sh"
source "$PROJECT_ROOT/modules/get.sh"
source "$PROJECT_ROOT/modules/session.sh"
source "$PROJECT_ROOT/modules/self_update.sh"
source "$PROJECT_ROOT/modules/tui.sh"
source "$PROJECT_ROOT/modules/uninstall.sh"